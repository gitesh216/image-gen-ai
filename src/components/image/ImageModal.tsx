    ...
    >
      <div className="flex items-center justify-between border-b px-3 py-2">
        ...
        <div className="flex items-center gap-2">
          <button className="rounded border px-2 py-1 text-xs hover:bg-muted" onClick={reset}>
            Reset
          </button>
          <button className="rounded border px-2 py-1 text-xs hover:bg-muted" onClick={onClose}>
            Close
          </button>
        </div>
      </div>
      <div
        className="relative grid h-[70dvh] place-items-center bg-black"
        onWheel={onWheel}
